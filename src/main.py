...
def publish(client: mqtt_client.Client, topic: str, datasource, delay: float, qos: int) -> None:
...
def run():
    ...
    qos_level = 1
    publish(client, config.MQTT_TOPIC, datasource, config.DELAY, qos=qos_level)
